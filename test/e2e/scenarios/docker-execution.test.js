...
conditionalDescribe('Docker Execution E2E', () => {
  ...
  describe('Docker Runtime Validation', () => {
    ...
    test('should verify target Docker image exists', async () => {
      ...
      if (!imageExists) {
        console.warn('⚠️ Docker image claude-code-runner:latest not found. This is expected in CI environments.');
        console.warn('   The image should be built before running E2E tests in local development.');
      }
